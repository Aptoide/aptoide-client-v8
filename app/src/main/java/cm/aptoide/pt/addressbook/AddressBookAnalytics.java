...
public class AddressBookAnalytics {
  ...
  public void sendSyncFacebookEvent() {
    analyticsManager.logEvent(createMapData(CHOOSE_NETWORK_ACTION,"Facebook"),FOLLOW_FRIENDS_CHOOSE_NETWORK,AnalyticsManager.Action.CLICK,
        getViewName(true));
  }
  ...
  public void sendShareYourPhoneSuccessEvent() {
    analyticsManager.logEvent(new HashMap<>(),FOLLOW_FRIENDS_SET_MY_PHONENUMBER, AnalyticsManager.Action.CLICK,
        getViewName(true));
  }
  ...
  private String getViewName(boolean isCurrent){
    ...
    if(viewName.equals("")) {
      return "AddressBookAnalytics"; //Default value, shouldn't get here
    }
    return viewName;
  }
}
