...
public class ReferrerUtils extends cm.aptoide.pt.dataprovider.util.referrer.ReferrerUtils {
  ...
  public static void extractReferrer(SearchAdResult searchAdResult, final int retries,
    ...
    if (clickUrl == null) {
      Logger.getInstance()
          .d("ExtractReferrer", "No click_url for packageName " + packageName);
      return;
    }
    ...
    try {
      Logger.getInstance()
          .d("ExtractReferrer", "Called for: " + clickUrl + " with packageName " + packageName);
      ...
      wv.setWebViewClient(new WebViewClient() {
        ...
        @Override public boolean shouldOverrideUrlLoading(WebView view, String clickUrl) {
          ...
          if (clickUrl.startsWith("market://")
            ...
            Logger.getInstance()
                .d("ExtractReferrer", "Clickurl landed on market");
            final String referrer = getReferrer(clickUrl);
            if (!TextUtils.isEmpty(referrer)) {
              Logger.getInstance()
                  .d("ExtractReferrer", "Referrer successfully extracted");
        ...
        private ScheduledFuture<Void> postponeReferrerExtraction(SearchAdResult searchAdResult,
          ...
          Callable<Void> callable = () -> {
            Logger.getInstance()
                .d("ExtractReferrer", "Sending RegisterAdRefererRequest with value " + success);
            ...
            Logger.getInstance()
                .d("ExtractReferrer", "Retries left: " + retries);
  ...
  private static String getReferrer(String uriAsString) {
    ...
    if (!TextUtils.isEmpty(referrer)) {
      Logger.getInstance()
          .v(TAG, "Found referrer: " + referrer);
    } else {
      Logger.getInstance()
          .v(TAG, "Didn't find any referrer: " + uriAsString);
    }
    return referrer;
  }
