...
public class GameCardTouchHandler extends ItemTouchHelper.SimpleCallback {
  ...
  @Override public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
    viewHolder.itemView.findViewById(R.id.stamp_left)
    ...
    if (viewHolder instanceof Game1ViewHolder || viewHolder instanceof Game2ViewHolder) {
      viewHolder.itemView.findViewById(R.id.right_answer)
          .setAlpha(1f);
      viewHolder.itemView.findViewById(R.id.left_answer)
          .setAlpha(1f);
    } else {
      viewHolder.itemView.findViewById(R.id.game_card_question3_answer_left)
          .setAlpha(1f);
      viewHolder.itemView.findViewById(R.id.game_card_question3_icon_left)
          .setAlpha(1f);
      viewHolder.itemView.findViewById(R.id.game_card_question3_answer_right)
          .setAlpha(1f);
      viewHolder.itemView.findViewById(R.id.game_card_question3_icon_right)
          .setAlpha(1f);
    }
    ...
    if(actionState== ItemTouchHelper.ACTION_STATE_SWIPE){
      if(dX > 0){
        ...
        if(dX<72) {
          ...
          } else if (viewHolder instanceof Game2ViewHolder) {
            viewHolder.itemView.findViewById(R.id.right_answer)
                .setAlpha(0.5f);
            viewHolder.itemView.findViewById(R.id.left_answer)
                .setAlpha(0.5f);
            viewHolder.itemView.findViewById(R.id.right_border)
                .setAlpha(0.5f);
            viewHolder.itemView.findViewById(R.id.left_border)
                .setAlpha(0.5f);
          } else{
  ...
  @Override public int getSwipeDirs(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
    if (!((viewHolder instanceof Game1ViewHolder)
        || (viewHolder instanceof Game2ViewHolder)
        || (viewHolder instanceof Game3ViewHolder))) {
      return 0;
    }
