  ...
  private void addMappedCardFromItem(LinksHandlerFactory linksFactory, List<Post> cards,
    ...
    if (item instanceof ArticleTimelineItem) {
      ...
      cards.add(new Media(article.getCardId(), article.getTitle(), article.getThumbnailUrl(),
          ...
          CardType.ARTICLE, article.getUrls()
          .getRead()));
      ...
      cards.add(new Recommendation(recommendation.getCardId(), recommendation.getRecommendedApp()
          ...
          CardType.RECOMMENDATION, recommendation.getUrls()
          .getRead()));
      ...
      cards.add(new Recommendation(recommendation.getCardId(), recommendation.getRecommendedApp()
          ...
          .get(0)
          .getPackageName(), new AptoidePublisher(), recommendation.getTimestamp(), abUrl, false,
          CardType.SIMILAR, recommendation.getUrls()
          .getRead()));
      ...
      cards.add(new AppUpdate(appUpdate.getCardId(), appUpdate.getStore()
          ...
          Install.InstallationStatus.UNINSTALLED, appUpdate.getUrls()
          .getRead()));
      ...
      cards.add(new RatedRecommendation(socialInstall.getCardId(),
          ...
          CardType.SOCIAL_INSTALL, socialInstall.getUrls()
          .getRead()));
      ...
      if (!TextUtils.isEmpty(socialArticle.getContent())) {
        cards.add(
            new SocialMedia(socialArticle.getCardId(), new Poster(user.getUser(), user.getStore()),
                ...
                socialArticle.getContent(), CardType.SOCIAL_POST_ARTICLE, socialArticle.getUrls()
                .getRead()));
      } else {
        ...
        cards.add(
            new SocialMedia(socialArticle.getCardId(), new Poster(user.getUser(), user.getStore()),
                ...
                socialArticle.getContent(), CardType.SOCIAL_ARTICLE, socialArticle.getUrls()
                .getRead()));
      }
      ...
      if (!TextUtils.isEmpty(socialVideo.getContent())) {
        cards.add(
            new SocialMedia(socialVideo.getCardId(), new Poster(user.getUser(), user.getStore()),
                ...
                socialVideo.getContent(), CardType.SOCIAL_POST_VIDEO, socialVideo.getUrls()
                .getRead()));
      } else {
        ...
        cards.add(
            new SocialMedia(socialVideo.getCardId(), new Poster(user.getUser(), user.getStore()),
                ...
                socialVideo.getContent(), CardType.SOCIAL_VIDEO, socialVideo.getUrls()
                .getRead()));
      }
      ...
      cards.add(new SocialStore(socialStoreLatestApps.getCardId(),
          ...
          sharedByName, CardType.SOCIAL_STORE, socialStoreLatestApps.getUrls()
          .getRead()));
      ...
      cards.add(new AggregatedMedia("n/a", posters, aggregatedSocialArticle.getTitle(),
          ...
          aggregatedSocialArticle.getUrls()
              .getRead()));
      ...
      cards.add(new AggregatedRecommendation("n/a", posters, subposts,
          ...
          CardType.AGGREGATED_SOCIAL_INSTALL, aggregatedSocialInstall.getUrls()
          .getRead()));
