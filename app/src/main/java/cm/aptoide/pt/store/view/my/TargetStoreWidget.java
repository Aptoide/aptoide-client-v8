...
public class TargetStoreWidget extends Widget<TargetStoreDisplayable> {
  ...
  public TargetStoreWidget(View itemView) {
    super(itemView);
  ...
  @Override public void bindView(TargetStoreDisplayable displayable) {
