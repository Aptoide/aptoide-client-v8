package cm.aptoide.pt.timeline.view.widget;
  ...
  @Override public void bindView(StoreLatestAppsDisplayable displayable) {
    ...
    for (View app : apps.keySet()) {
      compositeSubscription.add(RxView.clicks(app)
          .subscribe(click -> {
            ...
            displayable.sendStoreLatestAppsClickEvent(Analytics.AppsTimeline.OPEN_APP_VIEW,
                socialAction, packageName);
    ...
    compositeSubscription.add(RxView.clicks(store)
        .subscribe(click -> {
          ...
          displayable.sendStoreLatestAppsClickEvent(Analytics.AppsTimeline.OPEN_STORE, socialAction,
