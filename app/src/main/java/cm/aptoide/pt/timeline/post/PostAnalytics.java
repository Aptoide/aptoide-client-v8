...
public class PostAnalytics {
  ...
  public void sendOpenEvent(OpenSource source) {
    ...
    analyticsManager.logEvent(data, OPEN_EVENT_NAME, AnalyticsManager.Action.OPEN, TIMELINE);
  }

  public void sendClosePostEvent(CloseType closeType) {
    Map<String, Object> data = new HashMap<>();
    data.put("closeType", String.valueOf(closeType));
    analyticsManager.logEvent(data, NEW_POST_EVENT_NAME, AnalyticsManager.Action.DISMISS, TIMELINE);
  }
  ...
  public void sendPostCompleteNoTextEvent(boolean relatedAppsAvailable, boolean hasSelectedApp,
    ...
    analyticsManager.logEvent(facebookData, POST_COMPLETE, AnalyticsManager.Action.CLICK, TIMELINE);
    analyticsManager.logEvent(aptoideData, POST, AnalyticsManager.Action.CLICK, isExternal ? EXTERNAL : TIMELINE);
  }
