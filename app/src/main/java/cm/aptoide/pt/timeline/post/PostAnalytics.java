...
public class PostAnalytics {
  ...
  public void sendOpenEvent(OpenSource source, boolean isExternal) {
    ...
    analyticsManager.logEvent(data, OPEN_EVENT_NAME, AnalyticsManager.Action.CLICK,
        isExternal ? EXTERNAL : getViewName(false));
  }

  public void sendClosePostEvent(CloseType closeType, boolean isExternal) {
    Map<String, Object> data = new HashMap<>();
    data.put("closeType", String.valueOf(closeType));
    analyticsManager.logEvent(data, NEW_POST_EVENT_NAME, AnalyticsManager.Action.CLICK,
        isExternal ? EXTERNAL : getViewName(true));
  }
  ...
  public void sendPostCompleteNoTextEvent(boolean relatedAppsAvailable, boolean hasSelectedApp,
    ...
    Map<String, Object> facebookData =
        decorateMap(relatedAppsAvailable, hasSelectedApp, packageName, hasComment, hasUrl, url,
            hasUrlPreview, "missing", "No text inserted");
    Map<String, Object> aptoideData = createAptoideDataMap(false);

    analyticsManager.logEvent(facebookData, POST_COMPLETE, AnalyticsManager.Action.CLICK,
        isExternal ? EXTERNAL : getViewName(true));
    analyticsManager.logEvent(aptoideData, POST, AnalyticsManager.Action.CLICK,
        isExternal ? EXTERNAL : getViewName(true));
  }
  ...
  public void sendPostCompleteNoSelectedAppEvent(boolean relatedAppsAvailable, boolean hasComment,
    ...
    Map<String, Object> facebookData =
        decorateMap(relatedAppsAvailable, false, "", hasComment, hasUrl, url, hasUrlPreview,
  ...
  public void sendPostCompleteNoLoginEvent(boolean relatedAppsAvailable, boolean hasSelectedApp,
    ...
    Map<String, Object> facebookData =
        decorateMap(relatedAppsAvailable, hasSelectedApp, packageName, hasComment, hasUrl, url,
            hasUrlPreview, "missing", "Not logged in");
    Map<String, Object> aptoideData = createAptoideDataMap(false);
  ...
  public void sendPostCompleteNoAppFoundEvent(boolean relatedAppsAvailable, boolean hasSelectedApp,
    ...
    Map<String, Object> facebookData =
        decorateMap(relatedAppsAvailable, hasSelectedApp, packageName, hasComment, hasUrl, url,
            hasUrlPreview, "missing", "App not found");
    Map<String, Object> aptoideData = createAptoideDataMap(false);
  ...
  public void sendPostCompletedNetworkFailedEvent(boolean relatedAppsAvailable,
    ...
    Map<String, Object> facebookData =
        decorateMap(relatedAppsAvailable, hasSelectedApp, packageName, hasComment, hasUrl, url,
            hasUrlPreview, "fail", "Network error");
    Map<String, Object> aptoideData = createAptoideDataMap(false);
  ...
  public void sendPostCompleteEvent(boolean relatedAppsAvailable, String packageName,
    ...
    Map<String, Object> facebookData =
        decorateMap(relatedAppsAvailable, true, packageName, hasComment, hasUrl, url, hasUrlPreview,
            "success", "");
