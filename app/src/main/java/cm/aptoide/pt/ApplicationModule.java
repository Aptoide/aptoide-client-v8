...
public class ApplicationModule {
    ...
    @Singleton
    @Provides
    InstallerAnalytics providesInstallerAnalytics(
    ...
    @Singleton
    @Provides
    InstallAnalytics provideInstallAnalytics(AnalyticsManager analyticsManager,
    ...
    @Singleton
    @Provides
    AptoideDownloadManager provideAptoideDownloadManager(
    ...
    @Provides
    @Named("default")
    Installer provideDefaultInstaller(
    ...
    @Singleton
    @Provides
    InstallationProvider provideInstallationProvider(
    ...
    @Singleton
    @Provides
    DownloadRepository provideDownloadRepository(Database database) {
        return new DownloadRepository(new DownloadAccessor(database));
    }

    @Singleton
    @Provides
    Answers provideAnswers(Fabric fabric) {
        return fabric.getKit(Answers.class);
    }

    @Singleton
    @Provides
    Crashlytics provideCrashlytics(Fabric fabric) {
        return fabric.getKit(Crashlytics.class);
    }

    @Singleton
    @Provides
    TwitterCore provideTwitter(Fabric fabric) {
    ...
    @Singleton
    @Provides
    InstalledRepository provideInstalledRepository(
    ...
    @Singleton
    @Provides
    DownloadFactory provideDownloadFactory(
    ...
    @Singleton
    @Provides
    InstalledAccessor provideInstalledAccessor(Database database) {
        return new InstalledAccessor(database);
    }

    @Singleton
    @Provides
    DownloadAccessor provideDownloadAccessor(Database database) {
    ...
    @Singleton
    @Provides
    IdsRepository provideIdsRepository(
            @Named("default") SharedPreferences defaultSharedPreferences,
    ...
    @Singleton
    @Provides
    AndroidAccountProvider provideAndroidAccountProvider(
    ...
    @Singleton
    @Provides
    RootAvailabilityManager provideRootAvailabilityManager(
        ...
        return new RootAvailabilityManager(new RootValueSaver() {
            ...
            @Override
            public Completable save(boolean rootAvailable) {
    ...
    @Singleton
    @Provides
    AuthenticationPersistence provideAuthenticationPersistence(
    ...
    @Provides
    @Named("secure")
    SecurePreferences providesSecurePerefences(
            @Named("default") SharedPreferences defaultSharedPreferences,
    ...
    RootInstallationRetryHandler provideRootInstallationRetryHandler() {
        ...
        return new RootInstallationRetryHandler(notificationId,
                ...
                application.getInstallManager(), PublishRelay.create(), 0,
    ...
    @Singleton
    @Provides
    AptoideAccountManager provideAptoideAccountManager(AdultContent adultContent,
    ...
    @Provides
    @Named("default")
    OkHttpClient provideOkHttpClient(L2Cache httpClientCache,
    ...
    @Provides
    @Named("long-timeout")
    OkHttpClient provideLongTimeoutOkHttpClient(
            @Named("user-agent") Interceptor userAgentInterceptor,
            @Named("default") SharedPreferences sharedPreferences,
            @Named("retrofit-log") Interceptor retrofitLogInterceptor) {
        final OkHttpClient.Builder okHttpClientBuilder = new OkHttpClient.Builder();
    ...
    @Provides
    @Named("web-socket")
    OkHttpClient provideWebSocketOkHttpClient(
            @Named("user-agent") Interceptor userAgentInterceptor,
            @Named("default") SharedPreferences sharedPreferences,
            @Named("retrofit-log") Interceptor retrofitLogInterceptor) {
        final OkHttpClient.Builder okHttpClientBuilder = new OkHttpClient.Builder();
    ...
    @Singleton
    @Provides
    NotificationAccessor provideNotificationAccessor(Database database) {
    ...
    @Singleton
    @Provides
    SyncStorage provideSyncStorage() {
        return new SyncStorage(new HashMap<>());
    }

    @Singleton
    @Provides
    StoreUtilsProxy provideStoreUtilsProxy(AptoideAccountManager accountManager,
    ...
    @Singleton
    @Provides
    TokenInvalidator provideTokenInvalidator(
            @Named("default") OkHttpClient httpClient,
            @Named("default") SharedPreferences sharedPreferences,
            AuthenticationPersistence authenticationPersistence,
    ...
    @Singleton
    @Provides
    LocalPersistenceAdultContent provideLocalAdultContent(
    ...
    @Singleton
    @Provides
    AdultContent provideAdultContent(
    ...
    @Singleton
    @Provides
    Preferences provideDefaultPreferences(
            @Named("default") SharedPreferences sharedPreferences) {
    ...
    @Singleton
    @Provides
    StoreAccessor provideStoreAccessor(Database database) {
        return new StoreAccessor(database);
    }

    @Singleton
    @Provides
    SecureCoderDecoder provideSecureCoderDecoder(
            @Named("default") SharedPreferences sharedPreferences) {
    ...
    @Singleton
    @Provides
    StoreRepository provideStoreRepository(StoreAccessor storeAccessor) {
        return new StoreRepository(storeAccessor);
    }

    @Singleton
    @Provides
    PageViewsAnalytics providePageViewsAnalytics(
    ...
    @Singleton
    @Provides
    NotificationAnalytics provideNotificationAnalytics(
            AnalyticsManager analyticsManager, NavigationTracker navigationTracker) {
    ...
    @Singleton
    @Provides
    SearchAnalytics providesSearchAnalytics(AnalyticsManager analyticsManager,
    ...
    @Singleton
    @Provides
    NavigationTracker provideNavigationTracker(
    ...
    @Singleton
    @Provides
    AccountAnalytics provideAccountAnalytics(NavigationTracker navigationTracker,
                                             AnalyticsManager analyticsManager) {
    ...
    @Singleton
    @Provides
    AdultContentAnalytics provideAdultContentAnalytics(
            AnalyticsManager analyticsManager, NavigationTracker navigationTracker) {
    ...
    @Singleton
    @Provides
    DeepLinkAnalytics provideDeepLinkAnalytics(AnalyticsManager analyticsManager,
                                               NavigationTracker navigationTracker) {
    ...
    @Singleton
    @Provides
    StoreManager provideStoreManager(@Named("default") OkHttpClient okHttpClient,
                                     @Named("multipart") MultipartBodyInterceptor multipartBodyInterceptor,
    ...
    @Singleton
    @Provides
    AdsRepository provideAdsRepository(IdsRepository idsRepository,
    ...
    @Singleton
    @Provides
    NetworkOperatorManager providesNetworkOperatorManager(
            TelephonyManager telephonyManager) {
    ...
    @Singleton
    @Provides
    StoreCredentialsProvider providesStoreCredentialsProvider(
    ...
    @Singleton
    @Provides
    @Named("ws-prod-suggestions-base-url")
    String provideSearchBaseUrl() {
        return "http://"
    ...
    @Singleton
    @Provides
    SearchSuggestionManager providesSearchSuggestionManager(
    ...
    @Singleton
    @Provides
    Retrofit providesSearchSuggestionsRetrofit(
    ...
    @Singleton
    @Provides
    SearchSuggestionRemoteRepository providesSearchSuggestionRemoteRepository(
            Retrofit retrofit) {
    ...
    @Singleton
    @Provides
    RealmEventMapper providesRealmEventMapper(
    ...
    @Singleton
    @Provides
    EventsPersistence providesEventsPersistence(Database database,
    ...
    @Singleton
    @Provides
    AptoideBiEventService providesRetrofitAptoideBiService(@Named("pool-v7")
                                                                   BodyInterceptor<cm.aptoide.pt.dataprovider.ws.v7.BaseBody> bodyInterceptorPoolV7,
    ...
    @Singleton
    @Provides
    FirstLaunchAnalytics providesFirstLaunchAnalytics(
            AnalyticsManager analyticsManager) {
    ...
    @Provides
    @Named("aptoide")
    EventLogger providesAptoideEventLogger(
    ...
    @Provides
    @Named("facebook")
    EventLogger providesFacebookEventLogger(
    ...
    @Provides
    @Named("flurry")
    EventLogger providesFlurryEventLogger() {
    ...
    @Provides
    @Named("flurrySession")
    SessionLogger providesFlurrySessionLogger() {
        return new FlurryEventLogger(application);
    }
    ...
    @Provides
    @Named("fabric")
    EventLogger providesFabricEventLogger(Answers fabric) {
        return new FabricEventLogger(fabric);
    }

    @Singleton
    @Provides
    HttpKnockEventLogger providesknockEventLogger(
    ...
    @Provides
    @Named("aptoideEvents")
    Collection<String> provideAptoideEvents() {
    ...
    @Provides
    @Named("fabricEvents")
    Collection<String> provideFabricEvents() {
    ...
    @Singleton
    @Provides
    AppShortcutsAnalytics providesAppShortcutsAnalytics(
            AnalyticsManager analyticsManager, NavigationTracker navigationTracker) {
    ...
    @Singleton
    @Provides
    ReadPostsPersistence providesReadPostsPersistence() {
        return new ReadPostsPersistence(new ArrayList<>());
    }

    @Singleton
    @Provides
    TimelineAnalytics providesTimelineAnalytics(
    ...
    @Singleton
    @Provides
    StoreAnalytics providesStoreAnalytics(AnalyticsManager analyticsManager,
                                          NavigationTracker navigationTracker) {
