...
public class DeepLinkManager {
  ...
  private final UpdateNotificationAnalytics notificationAnalytics;
  ...
  public DeepLinkManager(StoreUtilsProxy storeUtilsProxy, FragmentNavigator fragmentNavigator,
      ...
      RoomStoreRepository storeRepository, UpdateNotificationAnalytics notificationAnalytics,
  ...
  public boolean showDeepLink(Intent intent) {
    if (intent.hasExtra(DeepLinkIntentReceiver.DeepLinksTargets.APP_VIEW_FRAGMENT)) {
      ...
      newUpdatesDeepLink(intent.getStringExtra(
          DeepLinkIntentReceiver.DeepLinksKeys.UPDATES_NOTIFICATION_GROUP));
