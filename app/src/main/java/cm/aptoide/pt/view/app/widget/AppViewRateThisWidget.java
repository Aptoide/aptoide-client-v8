...
import cm.aptoide.pt.view.app.displayable.AppViewRateThisDisplayable;
  ...
  private static final class ComunityRatingBar {
    ...
    public ComunityRatingBar(View view) {
      ...
      appview_rating_bar_rating_number5 =
          (TextView) view.findViewById(R.id.appview_rating_bar_rating_number5);
      ...
      appview_rating_bar_rating_number4 =
          (TextView) view.findViewById(R.id.appview_rating_bar_rating_number4);
      ...
      appview_rating_bar_rating_number3 =
          (TextView) view.findViewById(R.id.appview_rating_bar_rating_number3);
      ...
      appview_rating_bar_rating_number2 =
          (TextView) view.findViewById(R.id.appview_rating_bar_rating_number2);
      ...
      appview_rating_bar_rating_number1 =
          (TextView) view.findViewById(R.id.appview_rating_bar_rating_number1);
    }
