...
public class ActivityModule {
    ...
    @ActivityScope
    @Provides
    AutoUpdate provideAutoUpdate(DownloadFactory downloadFactory,
        ...
        return new AutoUpdate((ActivityView) activity, downloadFactory, permissionManager,
                application.getInstallManager(), resources, autoUpdateUrl,
    ...
    @ActivityScope
    @Provides
    SearchNavigator providesSearchNavigator(
    ...
    @ActivityScope
    @Provides
    AccountNavigator provideAccountNavigator(
    ...
    @ActivityScope
    @Provides
    ManageStoreNavigator provideManageStoreNavigator(
            FragmentNavigator fragmentNavigator) {
    ...
    @ActivityScope
    @Provides
    ManageUserNavigator provideManageUserNavigator(
            FragmentNavigator fragmentNavigator) {
