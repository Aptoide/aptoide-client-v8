...
public class ManageUserFragment$ViewModel$$Parcelable
    implements Parcelable, ParcelWrapper<cm.aptoide.pt.view.account.user.ManageUserFragment.ViewModel>
{

    private cm.aptoide.pt.view.account.user.ManageUserFragment.ViewModel viewModel$$0;
    @SuppressWarnings("UnusedDeclaration")
    public final static Creator<ManageUserFragment$ViewModel$$Parcelable>CREATOR = new Creator<ManageUserFragment$ViewModel$$Parcelable>() {


        @Override
        public ManageUserFragment$ViewModel$$Parcelable createFromParcel(android.os.Parcel parcel$$2) {
            return new ManageUserFragment$ViewModel$$Parcelable(read(parcel$$2, new IdentityCollection()));
        }
    ...
    public ManageUserFragment$ViewModel$$Parcelable(cm.aptoide.pt.view.account.user.ManageUserFragment.ViewModel viewModel$$2) {
    ...
    public static void write(cm.aptoide.pt.view.account.user.ManageUserFragment.ViewModel viewModel$$1, android.os.Parcel parcel$$1, int flags$$0, IdentityCollection identityMap$$0) {
    ...
    @Override
    public cm.aptoide.pt.view.account.user.ManageUserFragment.ViewModel getParcel() {
        return viewModel$$0;
    }

    public static cm.aptoide.pt.view.account.user.ManageUserFragment.ViewModel read(android.os.Parcel parcel$$3, IdentityCollection identityMap$$1) {
