...
public class DownloadInstallationProvider implements InstallationProvider {
  ...
  private final RoomStoreMinimalAdPersistence roomStoreMinimalAdPersistence;
  ...
  public DownloadInstallationProvider(AptoideDownloadManager downloadManager,
      ...
      MinimalAdMapper adMapper, RoomStoreMinimalAdPersistence roomStoreMinimalAdPersistence) {
    this.downloadManager = downloadManager;
    this.downloadAccessor = downloadAccessor;
    this.adMapper = adMapper;
    this.installedRepository = installedRepository;
    this.roomStoreMinimalAdPersistence = roomStoreMinimalAdPersistence;
  }
          ...
          if (download.getOverallDownloadStatus() == Download.COMPLETED) {
            return installedRepository.get(download.getPackageName(), download.getVersionCode())
                ...
                .doOnNext(downloadInstallationAdapter -> {
                  roomStoreMinimalAdPersistence.get(downloadInstallationAdapter.getPackageName())
                      .doOnNext(handleCpd())
  ...
  @NonNull private Action1<RoomStoreMinimalAd> handleCpd() {
    return storedMinimalAd -> {
      if (storedMinimalAd != null && storedMinimalAd.getCpdUrl() != null) {
        ...
        roomStoreMinimalAdPersistence.insert(storedMinimalAd);
      }
    };
  }
}
