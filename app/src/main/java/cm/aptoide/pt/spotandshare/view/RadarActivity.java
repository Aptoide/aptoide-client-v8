...
import cm.aptoide.pt.spotandshare.view.radar.RadarScan;
 ...
 */
public class RadarActivity extends SpotAndShareActivityView
    implements RadarView, PermissionManager {
