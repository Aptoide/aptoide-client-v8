...
public class HomeEvent {
  ...
  public enum Type {
    MORE, APP, AD, SOCIAL_CLICK, SCROLL_RIGHT, REWARD_APP, KNOW_MORE, DISMISS_BUNDLE, SOCIAL_INSTALL, EDITORIAL, INSTALL_WALLET, NO_OP, REACTION_BUTTON, REACTION, DELETE_REACTION;
  }
}
