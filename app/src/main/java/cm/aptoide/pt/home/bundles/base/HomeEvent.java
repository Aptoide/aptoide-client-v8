...
public class HomeEvent {
  ...
  public enum Type {
    MORE, MORE_TOP, APP, AD, SCROLL_RIGHT, REWARD_APP, APPC_KNOW_MORE, DISMISS_BUNDLE, SOCIAL_INSTALL, EDITORIAL, INSTALL_WALLET, NO_OP, REACT_SINGLE_PRESS, REACT_LONG_PRESS, REACTION, POPUP_DISMISS, LOAD_MORE_RETRY, INSTALL_PROMOTIONAL, ARTICLE_PROMOTIONAL, ESKILLS, ESKILLS_KNOW_MORE
  }
}
