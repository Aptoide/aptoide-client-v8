...
public class BundlesAdapter extends RecyclerView.Adapter<AppBundleViewHolder> {
  ...
  private static final int CUSTOM_BANNER = R.layout.custom_banner_item;
  ...
  @Override public AppBundleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    switch (viewType) {
      ...
      case CUSTOM_BANNER:
        return new CustomBannerBundleViewHolder(LayoutInflater.from(parent.getContext())
            .inflate(CUSTOM_BANNER, parent, false));
      default:
