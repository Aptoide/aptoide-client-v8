...
public interface HomeBundle {
  ...
  enum BundleType {
    EDITORS, APPS, ADS, UNKNOWN, LOADING, INFO_BUNDLE, APPCOINS_ADS, EDITORIAL, WALLET_ADS_OFFER, TOP, LOAD_MORE_ERROR, FEATURED_BONUS_APPC, NEW_APP, NEWS_ITEM, NEW_APP_VERSION, IN_GAME_EVENT, APP_COMING_SOON;
