...
class ListAppsMoreRepository(
  val storeCredentialsProvider: StoreCredentialsProvider,
  ...
  fun getApps(url: String?, refresh: Boolean): Observable<ListApps> {
    return ListAppsRequest.ofAction(
      url, storeCredentialsProvider.fromUrl(url), bodyInterceptor,
