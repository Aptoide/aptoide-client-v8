...
public class AptoideSyncAdapter extends AbstractThreadedSyncAdapter {
  ...
  public static final String EXTRA_PAYMENT_ID = "cm.aptoide.pt.Repository.sync.PAYMENT_ID";
  public static final String EXTRA_PAYMENT_AUTHORIZATIONS =
      "cm.aptoide.pt.Repository.sync.EXTRA_PAYMENT_AUTHORIZATIONS";
  public static final String EXTRA_PAYMENT_TRANSACTIONS =
      "cm.aptoide.pt.Repository.sync.EXTRA_PAYMENT_CONFIRMATIONS";
