...
import cm.aptoide.pt.sync.adapter.BillingSyncAdapterScheduler;
import cm.aptoide.pt.sync.adapter.ProductBundleMapper;
import cm.aptoide.pt.sync.alarm.NotificationAlarmManagerScheduler;
import cm.aptoide.pt.sync.alarm.NotificationSyncService;
      ...
      abTestManager = new ABTestManager(new SixpackBuilder(),
          new OkHttpClient.Builder().authenticator(
              new BasicAuthenticator(
                  BuildConfig.SIXPACK_USER, BuildConfig.SIXPACK_PASSWORD))
