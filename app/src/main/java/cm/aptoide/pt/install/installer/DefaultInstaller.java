...
public class DefaultInstaller implements Installer {
    ...
    @Override
    public Completable install(Context context, String md5, boolean forceDefaultInstall) {
    ...
    @Override
    public Completable update(Context context, String md5, boolean forceDefaultInstall) {
        return install(context, md5, forceDefaultInstall);
    }

    @Override
    public Completable downgrade(Context context, String md5, boolean forceDefaultInstall) {
        return installationProvider.getInstallation(md5)
                .first()
    ...
    @Override
    public Observable<InstallationState> getState(String packageName, int versionCode) {
    ...
    @NonNull
    private Observable<Void> waitPackageIntent(Context context, IntentFilter intentFilter,
                                               String packageName) {
