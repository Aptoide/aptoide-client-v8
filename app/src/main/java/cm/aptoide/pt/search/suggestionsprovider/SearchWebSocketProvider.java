...
class SearchWebSocketProvider {
  ...
  SearchWebSocketProvider() {
    scheduledExecutorService = Executors.newSingleThreadScheduledExecutor();
    client = new OkHttpClient();
  }

  SearchWebSocket getSearchAppsSocket(BlockingQueue<MatrixCursor> blockingQueue) {
  ...
  SearchWebSocket getStoreSearchSocket(BlockingQueue<MatrixCursor> blockingQueue) {
    Request request =
