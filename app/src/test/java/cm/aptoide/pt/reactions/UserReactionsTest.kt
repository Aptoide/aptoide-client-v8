...
class UserReactionsTest {
    ...
    fun noReactionsTest() {
        ...
        //And the user reacts
        Mockito.`when`(reactionRemoteService.setReaction(cardId, groupId, reaction)).thenReturn(Single.just(null))
    ...
    fun reactingSecondTimeWithDifferentReactionTest() {
        ...
        Mockito.`when`(reactionRemoteService.setSecondReaction(userId, reaction)).thenReturn(Single.just(null))
    ...
    fun secondReactionOnSecondCardTest() {
        ...
        Mockito.`when`(reactionRemoteService.setSecondReaction(userId, reaction)).thenReturn(Single.just(null))
        Mockito.`when`(reactionRemoteService.setReaction("2", groupId, reaction)).thenReturn(Single.just(null))
