...
/**
 * Created by danielchen on 06/09/17.
 */
...
public class LoginSignUpCredentialsFragment extends BackButtonFragment
    ...
    private void bindViews(View view) {
        ...
        buttonSignUp.setText(R.string.create_account);
        ...
        signUpSelectionButton.setText(getString(R.string.create_account));
