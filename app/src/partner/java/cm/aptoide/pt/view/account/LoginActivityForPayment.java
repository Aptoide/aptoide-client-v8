...
public class LoginActivityForPayment extends LoginBottomSheetActivity {
  ...
  @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      getFragmentNavigator().navigateToWithoutBackSave(
          LoginSignUpPaymentFragment.newInstance(false, true, false, accountType, authType, isNewAccount));
    }
  }
