  ...
  @ApplicationTestScope @Provides StoreManager provideStoreManager(
    ...
    final StoreManager storeManager =
        new StoreManager(accountManager, okHttpClient, WebService.getDefaultConverter(),
          ...
          @Override
          public Completable createOrUpdate(String a, String b, String c, boolean d, String e,boolean f,
              List<SocialLink> storeLinksList, List<cm.aptoide.pt.dataprovider.model.v7.store.Store.SocialChannelType> storeDeleteLinksList) {
            return Completable.complete();
          }
        };
    return storeManager;
