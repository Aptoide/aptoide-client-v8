...
public class AppViewFragment extends AptoideBaseFragment<BaseAdapter>
  ...
  @Override public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (i == R.id.menu_share) {
      ...
      final boolean appRatingExists =
          app != null && app.getStats() != null && app.getStats().getRating() != null;

      final float averageRating = appRatingExists ? app.getStats().getRating().getAvg() : 0f;

      final boolean appHasStore = app != null && app.getStore() != null;

      final Long storeId = appHasStore ? app.getStore().getId() : null;
