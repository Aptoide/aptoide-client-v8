...
public class DialogBadgeV7 extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		if (malware != null && malware.getReason() != null) {
			if (malware.getReason().getScanned() != null && malware.getReason().getScanned().getStatus() != null &&
					(Status.passed.equals(malware.getReason()
							.getScanned()
							.getStatus()) || Status.warn.equals(malware.getReason().getScanned().getStatus()))) {
			...
			if (malware.getReason().getSignatureValidated() != null && malware.getReason()
				...
				switch (malware.getReason().getSignatureValidated().getStatus()) {
					case passed:
						...
						((TextView) v.findViewById(R.id.tv_reason_signature_validation)).setText(getString(R.string
								.reason_signature));
						break;
					case failed:
...
// .string.application_signature_blacklisted));
			...
			if (malware.getReason().getManual() != null && malware.getReason().getManual().getStatus() != null &&
