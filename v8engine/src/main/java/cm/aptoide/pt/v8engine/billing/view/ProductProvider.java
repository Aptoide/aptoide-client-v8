...
public class ProductProvider {
  ...
  private ProductProvider(Billing billing, long appId, String storeName, boolean sponsored,
      int apiVersion, String sku, String packageName, String developerPayload) {
  ...
  public static ProductProvider fromBundle(Billing billing, Bundle bundle) {
    return new ProductProvider(billing, bundle.getLong(EXTRA_APP_ID, -1),
        ...
        bundle.getInt(EXTRA_API_VERSION, -1), bundle.getString(EXTRA_SKU),
        bundle.getString(EXTRA_PACKAGE_NAME), bundle.getString(EXTRA_DEVELOPER_PAYLOAD));
  }
  ...
  public static Bundle createBundle(int apiVersion, String packageName, String sku,
  ...
  public Single<Product> getProduct() {
    ...
    if (sku != null) {
      return billing.getProduct(packageName, apiVersion, sku, developerPayload);
    }
