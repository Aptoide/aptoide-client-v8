...
public class BaseWizardViewerFragment extends Fragment {
  ...
  private void setUpView(View view) {
    ...
    ViewPagerAdapterWizard viewPagerAdapterWizard =
        new ViewPagerAdapterWizard(getActivity().getSupportFragmentManager());
  ...
  private void setUpListeners(View view) {
    ...
    final LinearLayout nextIconSpace =
        (LinearLayout) view.findViewById(R.id.wizard_next_clickable_space);
