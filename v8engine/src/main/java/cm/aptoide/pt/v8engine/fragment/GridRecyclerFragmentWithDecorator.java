...
public abstract class GridRecyclerFragmentWithDecorator extends GridRecyclerFragment {
	...
	@Getter
	private final RecyclerView.ItemDecoration defaultItemDecoration = new RecyclerView.ItemDecoration() {
		@Override
		public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
			...
			if (activity != null) {
				offset = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5, activity.getResources().getDisplayMetrics());
			}
