...
public class PayPalPayment implements Payment {
  ...
  public PayPalPayment(Context context, int id, String type, String name, String sign, Price price,
      LocalBroadcastManager broadcastManager, PayPalConfiguration configuration,
      PayPalConverter converter, Product product, String methodLabel) {
  ...
  public class PaymentConfirmationReceiver extends BroadcastReceiver {
    ...
    @Override public void onReceive(Context context, Intent intent) {
      ...
      if (listener != null) {
        if (intent != null && PAYMENT_RESULT_ACTION.equals(intent.getAction()) && intent.hasExtra(
