...
public class MainActivity extends TabNavigatorActivity implements MainView,
    DeepLinkManager.DeepLinkMessages {
  ...
  @Partners @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    final DeepLinkManager deepLinkManager =
        new DeepLinkManager(storeUtilsProxy, storeRepository, fragmentNavigator, this,
            this);
    ...
    attachPresenter(
        new MainPresenter(this, new ApkFy(this, getIntent()), autoUpdate, new ContentPuller(this),
            ...
            CrashReport.getInstance(), fragmentNavigator, deepLinkManager), savedInstanceState);
  }
