...
public class PayPalPaymentActivity extends AppCompatActivity {
  ...
  private static final String PAYPAL_PAYMENT_EXTRA =
      "cm.aptoide.pt.v8engine.payment.service.extra.PAYPAL_PAYMENT";
  ...
  public static Intent getIntent(Context context,
      com.paypal.android.sdk.payments.PayPalPayment payment, PayPalConfiguration configuration) {
    return new Intent(context, PayPalPaymentActivity.class).putExtra(PAYPAL_PAYMENT_EXTRA, payment)
        .putExtra(PAYPAL_CONFIGURATION_EXTRA, configuration);
  }
