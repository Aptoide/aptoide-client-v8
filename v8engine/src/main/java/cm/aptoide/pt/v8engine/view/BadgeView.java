...
/**
 * A simple text label view that can be applied as a "badge" to any given {@link View}. This class is intended to be
 * instantiated at runtime rather than included in XML layouts.
 *
 * @author Jeff Gilfelt
 */
...
//	private static final int DEFAULT_TEXT_COLOR = Color.WHITE;
	...
	private void applyTo(View target) {
		...
		if (target instanceof TabWidget) {
			...
			((ViewGroup) target).addView(container, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams
					.FILL_PARENT));
