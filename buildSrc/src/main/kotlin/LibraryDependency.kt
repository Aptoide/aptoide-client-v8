...
object LibraryVersion {
  ...
  const val RETROFIT_GSON_CONVERTER = "2.11.0"
  ...
  const val COMPOSE_LIFECYCLE = "2.8.6"
  const val VIEWMODEL_COMPOSE = "2.8.6"
  ...
  const val GMS_PLAY_SERVICES_ADS = "18.1.0"
  const val PLAY_SERVICES_BASEMENT = "18.5.0"
  const val ACCOMPANIST_WEBVIEW = "0.36.0"
  const val ACCOMPANIST_PERMISSIONS = "0.36.0"
  const val LOTTIE_COMPOSE = "6.0.0"
  const val WORK_MANAGER = "2.9.1"
  const val HILT_WORK = "1.2.0"
