...
import cm.aptoide.pt.aptoide_ui.theme.appCoinsGradient

@Preview
@Composable
fun TestAppcoinsLogo() {
  Image(
    imageVector = getAppcoinsLogo(),
    contentDescription = null,
    modifier = Modifier.size(240.dp)
  )
}

fun getAppcoinsLogo(): ImageVector =
  ImageVector.Builder(
    name = "AppcoinsLogo",
    defaultWidth = 24.dp,
    defaultHeight = 24.dp,
