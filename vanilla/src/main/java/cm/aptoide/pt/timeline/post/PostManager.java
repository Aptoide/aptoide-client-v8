...
public class PostManager {
  ...
  public Single<List<PostRemoteAccessor.RelatedApp>> getSuggestionApps() {
    return postLocalRepository.getRelatedApps(null);
  }

  public Single<List<PostRemoteAccessor.RelatedApp>> getSuggestionApps(String url) {
    return postRemoteRepository.getRelatedApps(addProtocolIfNeeded(url));
  }

  public Single<List<PostRemoteAccessor.RelatedApp>> getSuggestionAppsOnStart(@Nullable String url) {
