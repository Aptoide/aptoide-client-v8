...
package cm.aptoide.pt.sync.adapter;
...
public class ProductBundleMapper {
  ...
  private static final String ID = "cm.aptoide.pt.Repository.sync.PRODUCT_ID";
  private static final String ICON = "cm.aptoide.pt.Repository.sync.PRODUCT_ICON";
  private static final String TITLE = "cm.aptoide.pt.Repository.sync.PRODUCT_TITLE";
  private static final String DESCRIPTION =
      "cm.aptoide.pt.Repository.sync.PRODUCT_DESCRIPTION";
  private static final String AMOUNT = "cm.aptoide.pt.Repository.sync.PRICE_AMOUNT";
  private static final String PACKAGE_VERSION_CODE =
      "cm.aptoide.pt.Repository.sync.PACKAGE_VERSION_CODE";

  private static final String SKU = "cm.aptoide.pt.Repository.sync.PRODUCT_SKU";
  private static final String PACKAGE_NAME =
      "cm.aptoide.pt.Repository.sync.PRODUCT_PACKAGE_NAME";
  private static final String APPLICATION_NAME =
      "cm.aptoide.pt.Repository.sync.PRODUCT_APPLICATION_NAME";
  private static final String DEVELOPER_PAYLOAD =
      "cm.aptoide.pt.Repository.sync.PRODUCT_DEVELOPER_PAYLOAD";
  private static final String TYPE = "cm.aptoide.pt.Repository.sync.PRODUCT_TYPE";
  private static final String API_VERSION =
      "cm.aptoide.pt.Repository.sync.PRODUCT_API_VERSION";

  private static final String APP_ID = "cm.aptoide.pt.Repository.sync.PRODUCT_APP_ID";
  private static final String STORE_NAME =
      "cm.aptoide.pt.Repository.sync.PRODUCT_STORE_NAME";
  private static final String SPONSORED =
      "cm.aptoide.pt.Repository.sync.PRODUCT_SPONSORED";
  private static final String TAX_RATE = "cm.aptoide.pt.Repository.sync.PRICE_TAX_RATE";
  private static final String CURRENCY = "cm.aptoide.pt.Repository.sync.PRICE_CURRENCY";
  private static final String CURRENCY_SYMBOL =
      "cm.aptoide.pt.Repository.sync.PRICE_CURRENCY_SYMBOL";
