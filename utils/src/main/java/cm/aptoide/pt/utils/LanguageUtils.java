...
public class LanguageUtils {
    ...
    public static String displayCountryAndLanguage(Locale locale){
        ...
        if(locale.getCountry().equalsIgnoreCase(locale.getLanguage()) || locale.getLanguage().equals(new Locale("he").getLanguage()) || locale.getLanguage().equals(new Locale("id").getLanguage())){
