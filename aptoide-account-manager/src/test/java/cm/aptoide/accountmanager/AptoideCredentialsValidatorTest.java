...
public class AptoideCredentialsValidatorTest {
  ...
  @Test public void shouldNotValidateLessThan8CharactersPassword() throws Exception {
    ...
    validator.validate(new AptoideCredentials("paul.mccartney@beatles.com", "1234567", true))
        .subscribe(testSubscriber);
  ...
  @Test public void shouldNotValidatePasswordWithout1LetterAnd1Number() throws Exception {
    ...
    validator.validate(
        new AptoideCredentials("paul.mccartney@beatles.com", "beatleswerethebest", true))
        .subscribe(test1);
    ...
    validator.validate(
        new AptoideCredentials("paul.mccartney@beatles.com", "123321432413241", true))
        .subscribe(test2);
