...
public class MyAccountActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.btn_access_token).setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Snackbar.make(v, AptoideAccountManager.getAccessToken(), Snackbar.LENGTH_LONG)
						.show();
			}
		});
		...
		findViewById(R.id.btn_refresh_token).setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Snackbar.make(v, SecurePreferences.getString
						("aptoide_account_manager_refresh_token_key"), Snackbar.LENGTH_LONG)
						.show();
			}
		});
	}
