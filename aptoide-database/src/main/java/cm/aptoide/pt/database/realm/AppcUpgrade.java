...
public class AppcUpgrade extends RealmObject {
  ...
  public AppcUpgrade(long id, String name, String icon, String packageName, String md5sum,
      String path, double fileSize, String versionName, String pathAlt, int versionCode,
      String rankName, String mainObbFileName, String mainObbPath, String mainObbMd5,
      String patchObbFileName, String patchObbPath, String patchObbMd5) {
    this.appId = id;
    this.label = name;
    this.icon = icon;
