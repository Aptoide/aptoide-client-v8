function! SvgToVector(fileName)
    ...
    for line in getline(1,"$")
        if line =~ '<svg.*'
          ...
          let line = substitute(line, '<svg.*>', '    imageVector = get'.name.'(),;\0', "gI")
          ...
          let line = substitute(line, '<svg.*>', '};;\0', "gI")
          let line = substitute(line, '<svg *\(.*\) *>', 'fun get'.name.'(): ImageVector = ImageVector.Builder(;  name = "'.name.'",;\1).apply {', "gI")
        ...
        elseif line =~ '<\/svg.*'
          let line = substitute(line, '<\/svg>', '\}\.build()', "gI")
        elseif line =~ '<path.*'
          let line = substitute(line, ' *id="[^"]*" *', '', "gI")
          ...
          let line = substitute(line, ' *A *'.number.'[ ,]\+'.number.'[ ,]\+'.number.'[ ,]\+0[ ,]\+0[ ,]\+'.number.'[ ,]\+'.number.'', '    arcTo(\1f, \2f, \3f, false, false, \4f, \5f);', "gI")
          let line = substitute(line, ' *A *'.number.'[ ,]\+'.number.'[ ,]\+'.number.'[ ,]\+0[ ,]\+1[ ,]\+'.number.'[ ,]\+'.number.'', '    arcTo(\1f, \2f, \3f, false, true, \4f, \5f);', "gI")
          let line = substitute(line, ' *A *'.number.'[ ,]\+'.number.'[ ,]\+'.number.'[ ,]\+1[ ,]\+0[ ,]\+'.number.'[ ,]\+'.number.'', '    arcTo(\1f, \2f, \3f, true, false, \4f, \5f);', "gI")
          let line = substitute(line, ' *A *'.number.'[ ,]\+'.number.'[ ,]\+'.number.'[ ,]\+1[ ,]\+1[ ,]\+'.number.'[ ,]\+'.number.'', '    arcTo(\1f, \2f, \3f, true, true, \4f, \5f);', "gI")
          let line = substitute(line, ' *a *'.number.'[ ,]\+'.number.'[ ,]\+'.number.'[ ,]\+0[ ,]\+0[ ,]\+'.number.'[ ,]\+'.number.'', '    arcToRelative(\1f, \2f, \3f, false, false, \4f, \5f);', "gI")
          let line = substitute(line, ' *a *'.number.'[ ,]\+'.number.'[ ,]\+'.number.'[ ,]\+0[ ,]\+1[ ,]\+'.number.'[ ,]\+'.number.'', '    arcToRelative(\1f, \2f, \3f, false, true, \4f, \5f);', "gI")
          let line = substitute(line, ' *a *'.number.'[ ,]\+'.number.'[ ,]\+'.number.'[ ,]\+1[ ,]\+0[ ,]\+'.number.'[ ,]\+'.number.'', '    arcToRelative(\1f, \2f, \3f, true, false, \4f, \5f);', "gI")
          let line = substitute(line, ' *a *'.number.'[ ,]\+'.number.'[ ,]\+'.number.'[ ,]\+1[ ,]\+1[ ,]\+'.number.'[ ,]\+'.number.'', '    arcToRelative(\1f, \2f, \3f, true, true, \4f, \5f);', "gI")
