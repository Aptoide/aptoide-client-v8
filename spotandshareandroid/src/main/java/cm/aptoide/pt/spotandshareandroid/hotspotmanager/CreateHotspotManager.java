...
class CreateHotspotManager {
  ...
  public boolean enablePrivateHotspot(String SSID, String password_aptoide) {
    return enableHotspot(new WifiConfigurationHelper().newPrivateWifi(SSID, password_aptoide))
        == SUCCESS_HOTSPOT_CREATION;
  }

  public boolean enableOpenHotspot(String SSID) {
    return enableHotspot(new WifiConfigurationHelper().newPublicWifi(SSID))
        == SUCCESS_HOTSPOT_CREATION;
  }
