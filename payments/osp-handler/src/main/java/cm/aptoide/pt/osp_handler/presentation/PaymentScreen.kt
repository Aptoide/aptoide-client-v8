...
fun PaymentScreenPreview() {
  PaymentScreen(
    Uri.parse("https://apichain.dev.catappult.io/transaction/inapp?product=gas&domain=com.appcoins.trivialdrivesample.test&callback_url=https%3A%2F%2Fwww.mygamestudio.com%2FcompletePurchase%3FuserId%3D1234&signature=76a21fc764668b1e31e13c7cb98f2768ab52b3415ba4cd3c6455d223cc3fdaa0")
    /*
    PurchaseRequest(
      scheme = "https",
