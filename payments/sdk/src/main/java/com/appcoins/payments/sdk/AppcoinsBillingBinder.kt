...
import com.appcoins.payments.sdk.sku_details.ProductSerializer
...
internal class AppcoinsBillingBinder(
  ...
  override fun isBillingSupported(
    ...
    val result =
      if (apiVersion != supportedApiVersion || merchantName.isNullOrBlank() || billingType != BillingType.INAPP) {
        ...
        runBlocking { productsRepository.isInAppBillingSupported(merchantName) }
      }
  ...
  override fun getPurchases(
    ...
    try {
      ...
      val purchases = runBlocking {
        ...
        productsRepository.getPurchases(merchantName, wallet.ewt)
      }
      logger.logBillingEvent(
        message = "buy_intent",
  ...
  override fun consumePurchase(
    ...
    return try {
      ...
      val purchaseConsumed = runBlocking {
        ...
        productsRepository.consumePurchase(
          domain = merchantName,
          uid = purchaseToken,
  ...
  private suspend fun getConsumables(
    ...
    for (i in skus.indices step 100) {
      ...
      val consumables =
        productsRepository.getConsumables(merchantName, tempSkus.joinToString(","))
