...
@Preview
@Composable
private fun TestLevelSevenBadge() {
  Image(
    imageVector = getLevelSevenBadge(),
    contentDescription = null,
    modifier = Modifier.size(240.dp)
  )
}

fun getLevelSevenBadge(): ImageVector = ImageVector.Builder(
  name = "LevelSevenBadge", defaultWidth = 168.0.dp, defaultHeight = 96.0.dp, viewportWidth =
  ...
  group {
    ...
    path(
      ...
      moveTo(100.14f, 27.84f)
      verticalLineTo(32.2f)
      lineTo(84.15f, 68.79f)
      horizontalLineTo(75.51f)
      lineTo(91.5f, 34.17f)
      horizontalLineTo(70.91f)
      verticalLineTo(27.84f)
