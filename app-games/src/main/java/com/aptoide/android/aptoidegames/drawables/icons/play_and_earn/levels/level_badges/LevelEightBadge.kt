...
@Preview
@Composable
private fun TestLevelEightBadge() {
  Image(
    imageVector = getLevelEightBadge(),
    contentDescription = null,
    modifier = Modifier.size(240.dp)
  )
}

fun getLevelEightBadge(): ImageVector = ImageVector.Builder(
  name = "LevelEightBadge", defaultWidth = 168.0.dp, defaultHeight = 96.0.dp, viewportWidth =
  ...
  group {
    ...
    path(
      fill = SolidColor(Color(0xFFB3CFFF)), stroke = null, strokeLineWidth = 0.0f,
      strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
      pathFillType = NonZero
    ) {
      moveTo(84.0f, 95.31f)
    ...
    path(
      fill = SolidColor(Color(0xFFE0ECFF)), stroke = null, strokeLineWidth = 0.0f,
      strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
      pathFillType = NonZero
    ) {
    ...
    path(
      fill = SolidColor(Color(0xFF495A6D)), stroke = null, strokeLineWidth = 0.0f,
      strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
      pathFillType = NonZero
    ) {
      moveTo(98.95f, 55.28f)
      curveTo(98.95f, 57.85f, 98.34f, 60.01f, 97.13f, 61.78f)
      curveTo(95.92f, 63.52f, 94.25f, 64.84f, 92.13f, 65.74f)
      curveTo(90.03f, 66.62f, 87.64f, 67.06f, 84.97f, 67.06f)
      curveTo(82.3f, 67.06f, 79.9f, 66.62f, 77.78f, 65.74f)
      curveTo(75.66f, 64.84f, 73.99f, 63.52f, 72.75f, 61.78f)
      curveTo(71.52f, 60.01f, 70.91f, 57.85f, 70.91f, 55.28f)
      curveTo(70.91f, 53.55f, 71.26f, 52.0f, 71.96f, 50.61f)
      curveTo(72.66f, 49.2f, 73.64f, 48.0f, 74.89f, 47.01f)
      curveTo(76.15f, 46.0f, 77.64f, 45.23f, 79.35f, 44.7f)
      curveTo(81.05f, 44.16f, 82.91f, 43.89f, 84.91f, 43.89f)
      curveTo(87.6f, 43.89f, 90.01f, 44.36f, 92.13f, 45.29f)
      curveTo(94.25f, 46.23f, 95.92f, 47.55f, 97.13f, 49.26f)
      curveTo(98.34f, 50.97f, 98.95f, 52.97f, 98.95f, 55.28f)
      close()
      moveTo(90.71f, 54.74f)
      curveTo(90.71f, 53.49f, 90.46f, 52.41f, 89.97f, 51.51f)
      curveTo(89.5f, 50.59f, 88.82f, 49.89f, 87.95f, 49.4f)
      curveTo(87.08f, 48.91f, 86.07f, 48.67f, 84.91f, 48.67f)
      curveTo(83.76f, 48.67f, 82.75f, 48.91f, 81.87f, 49.4f)
      curveTo(81.0f, 49.89f, 80.32f, 50.59f, 79.83f, 51.51f)
      curveTo(79.36f, 52.41f, 79.12f, 53.49f, 79.12f, 54.74f)
      curveTo(79.12f, 55.98f, 79.36f, 57.05f, 79.83f, 57.95f)
      curveTo(80.32f, 58.85f, 81.0f, 59.54f, 81.87f, 60.03f)
      curveTo(82.76f, 60.5f, 83.8f, 60.74f, 84.97f, 60.74f)
      curveTo(86.14f, 60.74f, 87.16f, 60.5f, 88.01f, 60.03f)
      curveTo(88.88f, 59.54f, 89.54f, 58.85f, 90.0f, 57.95f)
      curveTo(90.47f, 57.05f, 90.71f, 55.98f, 90.71f, 54.74f)
      close()
      moveTo(98.07f, 36.41f)
      curveTo(98.07f, 38.49f, 97.51f, 40.33f, 96.39f, 41.95f)
      curveTo(95.27f, 43.54f, 93.72f, 44.79f, 91.73f, 45.69f)
      curveTo(89.76f, 46.59f, 87.51f, 47.04f, 84.97f, 47.04f)
      curveTo(82.41f, 47.04f, 80.14f, 46.59f, 78.15f, 45.69f)
      curveTo(76.16f, 44.79f, 74.61f, 43.54f, 73.49f, 41.95f)
      curveTo(72.38f, 40.33f, 71.82f, 38.49f, 71.82f, 36.41f)
      curveTo(71.82f, 33.93f, 72.38f, 31.85f, 73.49f, 30.16f)
      curveTo(74.63f, 28.46f, 76.18f, 27.16f, 78.15f, 26.28f)
      curveTo(80.14f, 25.4f, 82.39f, 24.96f, 84.91f, 24.96f)
      curveTo(87.47f, 24.96f, 89.73f, 25.4f, 91.7f, 26.28f)
      curveTo(93.69f, 27.16f, 95.25f, 28.46f, 96.36f, 30.16f)
      curveTo(97.5f, 31.85f, 98.07f, 33.93f, 98.07f, 36.41f)
      close()
      moveTo(89.89f, 36.77f)
      curveTo(89.89f, 35.67f, 89.69f, 34.71f, 89.29f, 33.9f)
      curveTo(88.89f, 33.08f, 88.32f, 32.44f, 87.58f, 31.99f)
      curveTo(86.86f, 31.54f, 85.97f, 31.32f, 84.91f, 31.32f)
      curveTo(83.89f, 31.32f, 83.01f, 31.53f, 82.27f, 31.96f)
      curveTo(81.55f, 32.39f, 80.99f, 33.02f, 80.6f, 33.85f)
      curveTo(80.22f, 34.65f, 80.03f, 35.63f, 80.03f, 36.77f)
      curveTo(80.03f, 37.88f, 80.22f, 38.85f, 80.6f, 39.7f)
      curveTo(80.99f, 40.52f, 81.56f, 41.17f, 82.3f, 41.64f)
      curveTo(83.04f, 42.11f, 83.93f, 42.34f, 84.97f, 42.34f)
      curveTo(86.01f, 42.34f, 86.89f, 42.11f, 87.61f, 41.64f)
      curveTo(88.35f, 41.17f, 88.91f, 40.52f, 89.29f, 39.7f)
      curveTo(89.69f, 38.85f, 89.89f, 37.88f, 89.89f, 36.77f)
      close()
    }
    path(
      fill = SolidColor(Color(0xFF495A6D)), stroke = null, strokeLineWidth = 0.0f,
