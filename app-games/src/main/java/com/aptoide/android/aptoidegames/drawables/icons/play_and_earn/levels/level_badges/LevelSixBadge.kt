...
@Preview
@Composable
private fun TestLevelSixBadge() {
  Image(
    imageVector = getLevelSixBadge(),
    contentDescription = null,
    modifier = Modifier.size(240.dp)
  )
}

fun getLevelSixBadge(): ImageVector = ImageVector.Builder(
  name = "LevelSixBadge", defaultWidth = 168.0.dp, defaultHeight = 96.0.dp, viewportWidth =
  ...
  group {
    ...
    path(
      ...
      moveTo(91.05f, 24.96f)
      horizontalLineTo(92.24f)
      verticalLineTo(31.43f)
      horizontalLineTo(91.76f)
      curveTo(89.6f, 31.43f, 87.68f, 31.75f, 85.99f, 32.38f)
      curveTo(84.31f, 33.02f, 82.88f, 33.93f, 81.7f, 35.11f)
      curveTo(80.55f, 36.28f, 79.66f, 37.68f, 79.03f, 39.33f)
      curveTo(78.42f, 40.98f, 78.12f, 42.83f, 78.12f, 44.87f)
      verticalLineTo(51.68f)
      curveTo(78.12f, 53.14f, 78.26f, 54.44f, 78.55f, 55.56f)
      curveTo(78.85f, 56.67f, 79.28f, 57.59f, 79.83f, 58.34f)
      curveTo(80.39f, 59.08f, 81.06f, 59.63f, 81.81f, 60.0f)
      curveTo(82.57f, 60.36f, 83.42f, 60.54f, 84.37f, 60.54f)
      curveTo(85.26f, 60.54f, 86.07f, 60.35f, 86.79f, 59.98f)
      curveTo(87.52f, 59.6f, 88.15f, 59.08f, 88.66f, 58.4f)
      curveTo(89.19f, 57.71f, 89.59f, 56.9f, 89.85f, 55.98f)
      curveTo(90.14f, 55.04f, 90.28f, 54.02f, 90.28f, 52.92f)
      curveTo(90.28f, 51.81f, 90.14f, 50.79f, 89.85f, 49.85f)
      curveTo(89.59f, 48.91f, 89.19f, 48.11f, 88.66f, 47.43f)
      curveTo(88.13f, 46.74f, 87.49f, 46.2f, 86.73f, 45.83f)
      curveTo(85.97f, 45.45f, 85.12f, 45.27f, 84.17f, 45.27f)
      curveTo(82.88f, 45.27f, 81.75f, 45.57f, 80.76f, 46.17f)
      curveTo(79.8f, 46.75f, 79.04f, 47.5f, 78.49f, 48.42f)
      curveTo(77.94f, 49.33f, 77.65f, 50.3f, 77.61f, 51.31f)
      lineTo(75.14f, 49.74f)
      curveTo(75.2f, 48.29f, 75.5f, 46.93f, 76.05f, 45.63f)
      curveTo(76.62f, 44.34f, 77.39f, 43.19f, 78.38f, 42.2f)
      curveTo(79.38f, 41.19f, 80.58f, 40.4f, 81.98f, 39.84f)
      curveTo(83.39f, 39.26f, 84.97f, 38.97f, 86.73f, 38.97f)
      curveTo(88.66f, 38.97f, 90.36f, 39.33f, 91.81f, 40.06f)
      curveTo(93.29f, 40.79f, 94.52f, 41.8f, 95.51f, 43.07f)
      curveTo(96.49f, 44.35f, 97.23f, 45.82f, 97.72f, 47.49f)
      curveTo(98.22f, 49.16f, 98.46f, 50.94f, 98.46f, 52.83f)
      curveTo(98.46f, 54.82f, 98.13f, 56.67f, 97.47f, 58.37f)
      curveTo(96.82f, 60.08f, 95.89f, 61.57f, 94.66f, 62.84f)
      curveTo(93.44f, 64.12f, 91.98f, 65.11f, 90.28f, 65.83f)
      curveTo(88.58f, 66.54f, 86.66f, 66.89f, 84.54f, 66.89f)
      curveTo(82.34f, 66.89f, 80.35f, 66.5f, 78.55f, 65.71f)
      curveTo(76.77f, 64.91f, 75.23f, 63.78f, 73.95f, 62.34f)
      curveTo(72.66f, 60.89f, 71.66f, 59.18f, 70.96f, 57.19f)
      curveTo(70.28f, 55.2f, 69.94f, 53.03f, 69.94f, 50.67f)
      verticalLineTo(47.52f)
      curveTo(69.94f, 44.22f, 70.42f, 41.2f, 71.39f, 38.46f)
      curveTo(72.37f, 35.7f, 73.78f, 33.32f, 75.62f, 31.32f)
      curveTo(77.46f, 29.29f, 79.67f, 27.73f, 82.27f, 26.62f)
      curveTo(84.86f, 25.51f, 87.79f, 24.96f, 91.05f, 24.96f)
      close()
    }
    path(
      fill = SolidColor(Color(0xFFA97F07)), stroke = null, strokeLineWidth = 0.0f,
