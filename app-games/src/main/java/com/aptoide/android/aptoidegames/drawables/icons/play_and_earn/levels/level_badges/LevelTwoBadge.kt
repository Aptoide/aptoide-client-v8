...
@Preview
@Composable
private fun TestLevelTwoBadge() {
  Image(
    imageVector = getLevelTwoBadge(),
    contentDescription = null,
    modifier = Modifier.size(240.dp)
  )
}

fun getLevelTwoBadge(): ImageVector = ImageVector.Builder(
  name = "LevelTwoBadge", defaultWidth = 168.0.dp, defaultHeight = 96.0.dp, viewportWidth =
  ...
  group {
    ...
    path(
      ...
      moveTo(99.06f, 59.91f)
      verticalLineTo(66.24f)
      horizontalLineTo(70.76f)
      verticalLineTo(60.84f)
      lineTo(84.14f, 46.64f)
      curveTo(85.49f, 45.16f, 86.55f, 43.85f, 87.33f, 42.73f)
      curveTo(88.1f, 41.58f, 88.66f, 40.56f, 89.0f, 39.66f)
      curveTo(89.36f, 38.74f, 89.54f, 37.87f, 89.54f, 37.05f)
      curveTo(89.54f, 35.81f, 89.33f, 34.75f, 88.92f, 33.87f)
      curveTo(88.5f, 32.97f, 87.88f, 32.27f, 87.07f, 31.79f)
      curveTo(86.27f, 31.3f, 85.29f, 31.06f, 84.12f, 31.06f)
      curveTo(82.87f, 31.06f, 81.79f, 31.36f, 80.88f, 31.96f)
      curveTo(79.99f, 32.56f, 79.31f, 33.39f, 78.83f, 34.46f)
      curveTo(78.38f, 35.53f, 78.15f, 36.74f, 78.15f, 38.09f)
      horizontalLineTo(69.94f)
      curveTo(69.94f, 35.65f, 70.53f, 33.42f, 71.7f, 31.39f)
      curveTo(72.88f, 29.35f, 74.53f, 27.73f, 76.67f, 26.53f)
      curveTo(78.81f, 25.31f, 81.35f, 24.7f, 84.29f, 24.7f)
      curveTo(87.18f, 24.7f, 89.63f, 25.17f, 91.62f, 26.11f)
      curveTo(93.62f, 27.02f, 95.14f, 28.36f, 96.16f, 30.1f)
      curveTo(97.2f, 31.82f, 97.72f, 33.89f, 97.72f, 36.29f)
      curveTo(97.72f, 37.64f, 97.51f, 38.96f, 97.07f, 40.25f)
      curveTo(96.63f, 41.53f, 96.01f, 42.8f, 95.2f, 44.08f)
      curveTo(94.4f, 45.33f, 93.43f, 46.61f, 92.3f, 47.9f)
      curveTo(91.16f, 49.2f, 89.9f, 50.54f, 88.52f, 51.92f)
      lineTo(81.33f, 59.91f)
      horizontalLineTo(99.06f)
      close()
    }
    path(
      fill = linearGradient(
