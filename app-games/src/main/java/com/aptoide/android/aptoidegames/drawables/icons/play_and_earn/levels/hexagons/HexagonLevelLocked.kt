...
@Preview
@Composable
private fun TestHexagonLevelLocked() {
  Image(
    imageVector = getHexagonLevelLocked(),
    contentDescription = null,
    modifier = Modifier.size(240.dp)
  )
}

fun getHexagonLevelLocked(): ImageVector = ImageVector.Builder(
  name = "HexagonLevelLocked",
  ...
  path(
    fill = SolidColor(Color(0xFF312D35)), stroke = SolidColor(Color(0xFF595959)),
