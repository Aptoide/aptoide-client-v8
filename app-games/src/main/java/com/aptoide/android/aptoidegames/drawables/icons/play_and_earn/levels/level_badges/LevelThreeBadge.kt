...
@Preview
@Composable
private fun TestLevelThreeBadge() {
  Image(
    imageVector = getLevelThreeBadge(),
    contentDescription = null,
    modifier = Modifier.size(240.dp)
  )
}

fun getLevelThreeBadge(): ImageVector = ImageVector.Builder(
  name = "LevelThreeBadge", defaultWidth = 168.0.dp, defaultHeight = 96.0.dp, viewportWidth =
  ...
  group {
    ...
    path(
      ...
      moveTo(84.06f, 25.66f)
      curveTo(86.86f, 25.66f, 89.31f, 26.11f, 91.42f, 27.01f)
      curveTo(93.52f, 27.89f, 95.16f, 29.19f, 96.33f, 30.92f)
      curveTo(97.51f, 32.64f, 98.09f, 34.78f, 98.09f, 37.33f)
      curveTo(98.09f, 38.63f, 97.79f, 39.88f, 97.18f, 41.1f)
      curveTo(96.58f, 42.3f, 95.71f, 43.39f, 94.57f, 44.36f)
      curveTo(93.75f, 45.07f, 92.79f, 45.67f, 91.7f, 46.17f)
      curveTo(93.1f, 46.66f, 94.29f, 47.31f, 95.28f, 48.13f)
      curveTo(96.44f, 49.07f, 97.31f, 50.18f, 97.89f, 51.48f)
      curveTo(98.48f, 52.75f, 98.77f, 54.17f, 98.77f, 55.72f)
      curveTo(98.77f, 57.64f, 98.41f, 59.34f, 97.67f, 60.84f)
      curveTo(96.93f, 62.33f, 95.89f, 63.58f, 94.54f, 64.61f)
      curveTo(93.22f, 65.64f, 91.66f, 66.43f, 89.88f, 66.97f)
      curveTo(88.1f, 67.5f, 86.16f, 67.76f, 84.06f, 67.76f)
      curveTo(82.32f, 67.76f, 80.6f, 67.53f, 78.92f, 67.06f)
      curveTo(77.25f, 66.57f, 75.73f, 65.85f, 74.37f, 64.89f)
      curveTo(73.03f, 63.92f, 71.95f, 62.7f, 71.13f, 61.24f)
      curveTo(70.34f, 59.76f, 69.94f, 58.0f, 69.94f, 55.98f)
      horizontalLineTo(78.15f)
      curveTo(78.15f, 57.03f, 78.41f, 57.97f, 78.95f, 58.79f)
      curveTo(79.48f, 59.62f, 80.2f, 60.26f, 81.13f, 60.73f)
      curveTo(82.08f, 61.2f, 83.13f, 61.43f, 84.29f, 61.43f)
      curveTo(85.59f, 61.43f, 86.71f, 61.2f, 87.64f, 60.73f)
      curveTo(88.59f, 60.24f, 89.31f, 59.57f, 89.8f, 58.71f)
      curveTo(90.31f, 57.83f, 90.56f, 56.8f, 90.56f, 55.64f)
      curveTo(90.56f, 54.14f, 90.29f, 52.94f, 89.74f, 52.04f)
      curveTo(89.19f, 51.12f, 88.41f, 50.45f, 87.38f, 50.02f)
      curveTo(86.36f, 49.58f, 85.15f, 49.37f, 83.75f, 49.37f)
      horizontalLineTo(79.37f)
      verticalLineTo(43.21f)
      horizontalLineTo(83.75f)
      curveTo(85.15f, 43.21f, 86.3f, 42.97f, 87.21f, 42.51f)
      curveTo(88.12f, 42.02f, 88.79f, 41.34f, 89.23f, 40.48f)
      curveTo(89.68f, 39.6f, 89.91f, 38.58f, 89.91f, 37.42f)
      curveTo(89.91f, 36.37f, 89.7f, 35.44f, 89.29f, 34.63f)
      curveTo(88.89f, 33.81f, 88.27f, 33.17f, 87.44f, 32.72f)
      curveTo(86.61f, 32.25f, 85.56f, 32.02f, 84.29f, 32.02f)
      curveTo(83.28f, 32.02f, 82.35f, 32.21f, 81.5f, 32.61f)
      curveTo(80.65f, 33.0f, 79.97f, 33.55f, 79.46f, 34.27f)
      curveTo(78.95f, 34.98f, 78.69f, 35.84f, 78.69f, 36.85f)
      horizontalLineTo(70.48f)
      curveTo(70.48f, 34.6f, 71.09f, 32.64f, 72.3f, 30.98f)
      curveTo(73.53f, 29.31f, 75.18f, 28.0f, 77.24f, 27.07f)
      curveTo(79.31f, 26.13f, 81.58f, 25.66f, 84.06f, 25.66f)
      close()
    }
    path(
      fill = SolidColor(Color(0xFF676D89)), stroke = null, strokeLineWidth = 0.0f,
