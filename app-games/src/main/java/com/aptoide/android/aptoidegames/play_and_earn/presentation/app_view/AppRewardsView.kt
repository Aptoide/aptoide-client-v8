...
import com.aptoide.android.aptoidegames.play_and_earn.domain.Mission
import com.aptoide.android.aptoidegames.play_and_earn.domain.MissionStatus
import com.aptoide.android.aptoidegames.play_and_earn.domain.missions
...
fun AppRewardsView(
  ...
  val missions = remember { missions }

  Column {
    CheckpointsSection(missions.checkpoints)
...
@Composable
private fun CheckpointsSection(checkpoints: List<Mission>) {
  Column(
    modifier = Modifier.padding(16.dp),
    verticalArrangement = Arrangement.spacedBy(16.dp)
  ) {
...
@Composable
private fun CheckpointItem(checkpoint: Mission) {
  Box(
    modifier = Modifier
      .fillMaxWidth()
    ...
    Row(
      ...
      Column(
        ...
        Row(
          ...
          Text(
            text = getAppXPAnnotatedString(20, 50),
