...
import com.aptoide.android.aptoidegames.support.analytics.SupportAnalytics
...
@Composable
fun rememberSupportAnalytics(): SupportAnalytics = runPreviewable(
  preview = {
    SupportAnalytics(
  ...
  real = {
    ...
    val supportAnalytics = remember(key1 = genericAnalytics) {
      SupportAnalytics(
