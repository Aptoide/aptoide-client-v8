...
import com.aptoide.android.aptoidegames.drawables.icons.play_and_earn.getPlayAndEarnCoins
import com.aptoide.android.aptoidegames.drawables.icons.play_and_earn.getPlayAndEarnSmallLogo
import com.aptoide.android.aptoidegames.theme.AGTypography
import com.aptoide.android.aptoidegames.theme.Palette

@Composable
fun PlayAndEarnHomeSmallCard(
  onClick: () -> Unit = {}
) {
  Box(
    modifier = Modifier
      ...
      Row(
        ...
        Column(
          ...
          Row(
            ...
            Image(
              imageVector = getPlayAndEarnSmallLogo(Palette.White, Palette.Secondary),
              contentDescription = null,
    ...
    Image(
      modifier = Modifier
        ...
        .padding(end = 48.dp),
      imageVector = getPlayAndEarnCoins(),
      contentDescription = null,
      contentScale = ContentScale.FillHeight
    )
  }
...
@Preview
@Composable
private fun PlayAndEarnHomeCardPreview() {
  Box(
    modifier = Modifier.width(360.dp),
    contentAlignment = Alignment.Center
  ) {
    PlayAndEarnHomeSmallCard()
  }
}
