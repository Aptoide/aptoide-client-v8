...
fun AGButtonPreview() {
  AptoideTheme {
    Column(
      ...
      PlayAndEarnSmallCoinButton(title = "Install", onClick = {})
      PlayAndEarnLargeCoinButton(title = "Install", onClick = {})
      PlayAndEarnSmallTextButton(title = "Install", onClick = {})
      PlayAndEarnLargeTextButton(title = "Install", onClick = {})
    }
  }
}

@Composable
fun PlayAndEarnLargeCoinButton(
  title: String,
  onClick: () -> Unit,
...
@Composable
fun PlayAndEarnSmallCoinButton(
  title: String,
  onClick: () -> Unit,
  modifier: Modifier = Modifier,
  enabled: Boolean = true,
...
@Composable
fun PlayAndEarnSmallTextButton(
  title: String,
  onClick: () -> Unit,
  modifier: Modifier = Modifier,
  enabled: Boolean = true,
...
@Composable
fun PlayAndEarnLargeTextButton(
  title: String,
  onClick: () -> Unit,
  modifier: Modifier = Modifier,
  enabled: Boolean = true,
