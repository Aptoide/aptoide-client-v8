...
@Preview
@Composable
private fun TestLevelFourBadge() {
  Image(
    imageVector = getLevelFourBadge(),
    contentDescription = null,
    modifier = Modifier.size(240.dp)
  )
}

fun getLevelFourBadge(): ImageVector = ImageVector.Builder(
  name = "LevelFourBadge", defaultWidth = 168.0.dp, defaultHeight = 96.0.dp, viewportWidth =
  ...
  group {
    ...
    path(
      ...
      moveTo(97.23f, 50.61f)
      verticalLineTo(56.97f)
      horizontalLineTo(67.43f)
      lineTo(67.03f, 52.04f)
      lineTo(84.28f, 24.96f)
      horizontalLineTo(90.78f)
      lineTo(83.74f, 36.63f)
      lineTo(75.16f, 50.61f)
      horizontalLineTo(97.23f)
      close()
      moveTo(92.54f, 24.96f)
      verticalLineTo(65.91f)
      horizontalLineTo(84.36f)
      verticalLineTo(24.96f)
      horizontalLineTo(92.54f)
      close()
    }
    path(
      fill = SolidColor(Color(0xFF676D89)), stroke = null, strokeLineWidth = 0.0f,
