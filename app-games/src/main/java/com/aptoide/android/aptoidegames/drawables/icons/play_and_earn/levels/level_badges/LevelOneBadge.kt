...
@Preview
@Composable
private fun TestLevelOneBadge() {
  Image(
    imageVector = getLevelOneBadge(),
    contentDescription = null,
    modifier = Modifier.size(240.dp)
  )
}

fun getLevelOneBadge(): ImageVector = ImageVector.Builder(
  name = "LevelOneBadge", defaultWidth = 168.0.dp, defaultHeight = 96.0.dp, viewportWidth =
