 ...
 */
@Data @EqualsAndHashCode(callSuper = true) public class InAppBillingSkuDetailsResponse
  ...
  @Data public static class PublisherResponse {
    ...
    @JsonProperty("DETAILS_LIST") private List<PurchaseDataObject> detailList;
  }

  @Data public static class PurchaseDataObject {
