...
public class GetStoreMetaRequest extends BaseRequestWithStore<GetStoreMeta, GetStoreMetaRequest.Body> {
	...
	protected GetStoreMetaRequest(String storeName, boolean bypassCache) {
		super(storeName, bypassCache, new Body());
	}

	protected GetStoreMetaRequest(long storeId, boolean bypassCache) {
		super(storeId, bypassCache, new Body());
	}

	public static GetStoreMetaRequest of(String storeName, boolean bypassCache) {
		return new GetStoreMetaRequest(storeName, bypassCache);
	}

	public static GetStoreMetaRequest of(int storeId, boolean bypassCache) {
		return new GetStoreMetaRequest(storeId, bypassCache);
	}
