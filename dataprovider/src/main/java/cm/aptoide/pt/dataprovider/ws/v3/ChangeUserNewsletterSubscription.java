...
public class ChangeUserNewsletterSubscription extends V3<BaseV3Response> {

  protected ChangeUserNewsletterSubscription(BaseBody baseBody, OkHttpClient httpClient,
  ...
  public static ChangeUserNewsletterSubscription of(String subscribe,
    ...
    return new ChangeUserNewsletterSubscription(body, httpClient, converterFactory, bodyInterceptor,
        tokenInvalidator, sharedPreferences);
  }

  @Override
  protected Observable<BaseV3Response> loadDataFromNetwork(Service service, boolean bypassCache) {
    return service.changeUserNewsletterSubscription(map, bypassCache);
  }
}
