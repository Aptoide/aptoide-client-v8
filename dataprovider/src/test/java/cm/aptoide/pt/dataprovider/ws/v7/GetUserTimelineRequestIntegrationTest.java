...
public class GetUserTimelineRequestIntegrationTest {
  ...
  @Test public void shouldReturnAppUpdate() throws Exception {
    ...
    final List<TimelineItem<TimelineCard>> items = Arrays.asList(new AppUpdateTimelineItem(
        getAppUpdate(null, 18849509, "Home Budget " + "with Sync Lite",
            "com.anishu.homebudget.lite", 2372649, "http://pool.img.aptoide" +
                ".com/apps/db4d92cd5e5d1df2fa8d679853db4810_icon" + ".png", "2016-05-05 17:29:34",
            "2016-05-05" + " 17:29:34", "2016-06-16 03:21:48", "webservice",
            getFile("3" + ".2.2", 39, "4401f53566e6402e3ae6f69f89518c65",
                "http://pool.apk.aptoide" +
  ...
  @Test public void shouldReturnLatestApps() throws Exception {
    ...
    testSubscriber.assertNoErrors();
    testSubscriber.assertValueCount(1);
    final List<TimelineItem<TimelineCard>> storeLatestAppsTimelineItems = Arrays.asList(
        new StoreLatestAppsTimelineItem(new StoreLatestApps(null,
            getStore(id, name, avatar, getDate("UTC", added, "yyyy-MM-dd hh:mm:ss"),
                getDate("UTC", modified, "yyyy-MM-dd hh:mm:ss"), getAppearance(description, theme),
                getStats(apps, subscribers, downloads)), Arrays.asList(
  ...
  @Test public void shouldReturnFeatures() throws Exception {
    ...
    testSubscriber.assertNoErrors();
    testSubscriber.assertValueCount(1);
    final List<TimelineItem<TimelineCard>> items = Arrays.asList(new FeatureTimelineItem(
        new Feature(null, "Here, have a Xiaomi " + "Redmi Note 3 pro on us",
  ...
  @Test public void shouldReturnArticles() throws Exception {
  ...
  @Test public void shouldReturnEmptyList() throws Exception {
    ...
    testSubscriber.assertValue(
        getUserTimeline(BaseV7Response.Info.Status.OK, 0.0098769664764404, "9 " + "milliseconds",
            getDataList(Collections.emptyList(), true, 0, 25, 25, 0, 9, 11)));
    testSubscriber.assertCompleted();
  ...
  @NonNull private GetUserTimelineRequest getGetUserTimelineRequest(String url, String baseHost,
    ...
    return new GetUserTimelineRequest(url, new GetUserTimelineRequest.Body(limit, offset, packages),
        OkHttpClientFactory.newClient(), WebService.getDefaultConverter(), baseHost);
  }
