...
public class GetStoreWidgets extends BaseV7Response {
	...
	public static class Datalist {
		...
		@JsonProperty("list") public List<Datalist.WidgetList> widgetList = new ArrayList<>();
		...
		public static class WidgetList {
			...
			private List<Datalist.WidgetList.Action> actions = new ArrayList<>();
			private Datalist.WidgetList.Data data;
			...
			public static class Data {
				...
				private String icon;
				private List<Datalist.WidgetList.Data.Categories> categories = new ArrayList<>(); //only present if type": "DISPLAYS"
			...
			public static class Action {
				...
				private String tag;
				private Datalist.WidgetList.Action.Event event;
