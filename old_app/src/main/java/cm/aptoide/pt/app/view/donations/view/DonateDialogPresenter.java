...
public class DonateDialogPresenter implements Presenter {
  ...
  private final DonateDialogView view;
  private final WalletService walletService;
  private final AppNavigator appNavigator;
  private final DonationsAnalytics donationsAnalytics;
  ...
  private void handleDonateClick() {
    ...
    subscriptions.add(view.donateClick()
        ...
        .flatMap(result -> walletService.getWalletAddress(result.getPackageName())
            .toObservable()
