...
class EditorialItemsViewHolder extends RecyclerView.ViewHolder {
  ...
  private final TextSwitcher descriptionSwitcher;
  private final View itemText;
  ...
  private final WebView embeddedVideo;
  ...
  private final MediaBundleAdapter mediaBundleAdapter;
  private final PublishSubject<EditorialEvent> uiEventListener;
  private final LinearLayout downloadInfoLayout;
  private final ProgressBar downloadProgressBar;
  private final TextView downloadProgressValue;
  private final ImageView cancelDownload;
  private final ImageView pauseDownload;
  private final ImageView resumeDownload;
  private final View downloadControlsLayout;
  private final RelativeLayout cardInfoLayout;
