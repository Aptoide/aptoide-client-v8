...
public class DownloadServiceHelper {
	 ...
	 */
	public Observable<Download> startDownload(DownloadAccessor downloadAccessor, PermissionRequest permissionRequest, Download download) {
	...
	public Observable<Download> startDownload(PermissionRequest permissionRequest, Download download) {
		return startDownload(AccessorFactory.getAccessorFor(Download.class), permissionRequest, download);
	}
