...
public class SpotAndSharePickAppsFragment extends FragmentView implements SpotAndSharePickAppsView {
  ...
  public static Fragment newInstance(boolean shouldCreateGroup) {
    ...
    Fragment fragment = new SpotAndSharePickAppsFragment();
  ...
  @Override public void onViewCreated(android.view.View view, @Nullable Bundle savedInstanceState) {
    ...
    adapter = new SpotAndSharePickAppsAdapter(appSubject,
        new Header(getResources().getString(R.string.spotandshare_title_pick_apps_to_send)));
    recyclerView.setAdapter(adapter);
    setupLayoutManager();
    recyclerView.setHasFixedSize(true);

    attachPresenter(new SpotAndSharePickAppsPresenter(this, shouldCreateGroup,
